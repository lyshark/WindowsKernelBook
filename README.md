...
本书创作全程不以盈利为目的，亦无商业出版计划，现已完成版权登记并正式公开发布。创作初衷纯粹是为深耕 Windows 内核安全领域的爱好者提供学习参考，帮助大家系统掌握反内核相关知识，厘清内核关键数据结构的定位、读取思路，做到触类旁通、灵活运用，技术本就需要传承与分享。

在此也诚挚呼吁业内前辈同仁，进一步梳理、公开内核逆向中各类结构的定位检索方案，加快相关技术成果开源进程，降低底层技术的学习门槛。谨以此书抛砖引玉，推动以往相对闭塞的底层内核逆向知识走向大众化普及。
